...
<form action="/product-create-submit" method="POST" id="product-form">
@csrf
          ...
          <div class="tab-content add-listing-tab-content" id="vert-tabs-tabContent">
            ...
            <div class="tab-pane text-left fade @if(session()->get('user_role') == 2) show active @endif mt-2" id="vert-tabs-basic" role="tabpanel" aria-labelledby="vert-tabs-basic-tab">
              <h4>Basic Info</h4>
                ...
                <input type="text" class="form-control" onkeyup="setSulg(this)" name="title" id="title" placeholder="Enter Product Title" autofocus value="" required>
                </div>
                <div class="form-group">
                <label for="sku">SKU</label>
                <input type="text" class="form-control" name="sku" id="sku" placeholder="Enter SKU" value="" required>
            ...
            <div class="tab-pane fade mt-2" id="vert-tabs-stock" role="tabpanel" aria-labelledby="vert-tabs-stock-tab">
              <h4>Pricing</h4>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="price" id="price" placeholder="Enter Selling Price" value="" required>
                </div>
                <div class="form-group">
                    <label for="weight">Weight(g)</label>
                    <input type="number" class="form-control" name="weight" id="weight" placeholder="Enter Weight in grams" value="" required>
                </div>
                <div class="form-group">
                    <label for="stock">Stock</label>
                    <input type="number" class="form-control" name="stock" id="stock" placeholder="Enter Stock" value="" required>
                </div>
            </div>
            ...
            <div class="tab-pane fade mt-2" id="vert-tabs-description" role="tabpanel" aria-labelledby="vert-tabs-description-tab">
              <h4>Product Description</h4>
                <div class="form-group">
                    ...
                    <textarea id="short_description" id="short_description" name="short_description" rows="3" cols="80" required></textarea>
                </div>
                <div class="form-group">
                    <label for="long_description">Long Description</label>
                    <textarea id="long_description" name="long_description" rows="3" cols="80" required></textarea>
                </div>
            </div>
                  ...
                  <div class="col-lg-3">
                    ...
                    <!-- <div class="col-lg-3">
                      <div class="card card-widget product-card">
                        <div>
                          <button type="button" class="btn btn-danger btn-sm float-right" style="width: 15%;"><i class="fa fa-times" aria-hidden="true"></i></button>
                        </div>
                        <div class="custom card-body">
                          <div class="img-parent">
                              <div class="imag-wrapper">
                                <img class="img-fluid pad" src="https://www.webstoresl.com/sellercenter/assets/images/8f918d7ddfbc35eafb17bc748f70c4da.webp" alt="">
                              </div>
                          </div>
                        </div>
                      </div>       
            ...
            <div class="tab-pane fade mt-2" id="vert-tabs-seo" role="tabpanel" aria-labelledby="vert-tabs-seo-tab">
              <h4>SEO</h4>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control slug" name="slug" id="slug" placeholder="Enter Product Slug" required>
                  </div>
                  <div class="form-group">
                      <label for="meta_title">Meta Title</label>
                      <input type="text" class="form-control" name="meta_title" id="meta_title" placeholder="Enter Product Meta Title">
                  </div>
                  <div class="form-group">
                      <label for="meta_description">Meta Description</label>
                      <input type="text" class="form-control" name="meta_description" id="meta_description"placeholder="Enter Product Meta Description">
                  </div>
            </div>
          </div>
        </div>
